...
#if DEBUG
/// Preview data for SwiftUI previews using the modern #Preview macro
enum PreviewData {
    static var goal: Goal {
        Goal(
            ...
            importance: 8,
            why: "I want to feel more energetic"
        )
    }

    static var stats: UserStats {
        UserStats(
            todayMinutesEarned: 32,
            lifetimeMinutesEarned: 1240,
            currentStreakDays: 7,
